...
void AGE_Frame::OnGameVersionChange()
{
    if(DataOpened)  // Hiding stuff according to game version should be here.
    {
        ...
        Units_ChargeProjectileUnit_Holder->Show(emerge);
        Units_AttackPriority_Holder->Show(emerge);
        Units_InvulnerabilityLevel_Holder->Show(emerge);
        Units_ButtonIconID_Holder->Show(emerge);
        Units_ButtonShortTooltipID_Holder->Show(emerge);
        Units_ButtonExtendedTooltipID_Holder->Show(emerge);
        Units_ButtonHotkeyAction_Holder->Show(emerge);
